          ...
          <div className="relative container lg:rounded-2xl bg-transparent dark:bg-transparent  px-4 sm:px-5 md:px-10 lg:px-20">
            <div className="grid grid-cols-12 md:gap-10 pt-4 md:pt-[40px]">
              <div className="col-span-8 md:col-span-4">
                ...
                <img
                  className="w-full h-full md:w-[330px] md:h-[400px] mt-10 object-cover overflow-hidden rounded-[35px] md:mb-0 shadow-2xl"
                  src={aboutImage}
                  alt=""
                />
              </div>
              <div className="col-span-12 md:col-span-8 space-y-2.5 items-center">
                ...
                <div className=" md:mr-12 xl:mr-16">
                  ...
                  <p className="text-gray-lite text-lg dark:text-color-910 leading-7">
                    ...
                    My current career goal is to secure a full-time position in
                    this industry, where I can leverage the skills and
                    experience I gained during my time at Auckland University of
                    Technology. Throughout my academic career, I was fortunate
                    enough to take on leadership roles in several group
                    projects. These experiences ignited my love for bringing a
                    team together to achieve a common goal, and I found myself
                    thriving in these environments. As I look towards the
                    future, my ultimate career goal is to transition into a
                    project leadership role. I am excited about the prospect of
