    ...
    <>
      ...
      >
        <img
          ...
          alt=""
        />
        <h2 className="mt-6 mb-1 text-7xl font-kanit dark:text-white">
          Joshua Stroud
        </h2>
        ...
        <button className="flex items-center bg-gradient-to-r from-[#1e1255] to-[#1e1255] duration-200 transition ease-linear hover:bg-gradient-to-l from-[#DD2476]  to-[#fa5252ef] px-8 py-3 text-lg text-white rounded-[35px] mt-6">
