...
const particlesLoaded = useCallback(async container => {
  ...
  />
      ...
      >
        ...
        <button className="flex items-center bg-[#FAEAE7] duration-200 transition ease-linear hover:bg-gray px-8 py-3 text-lg text-black outline-black rounded-[35px] mt-6">
