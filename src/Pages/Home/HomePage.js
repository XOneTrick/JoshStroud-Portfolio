...
const particlesLoaded = useCallback(async container => {
  ...
  />
      ...
      >
        ...
        <img
          className="rounded-full mt-24 mb-10 w-[450px] h-[450px] 2xl:w-[330px] 2xl:h-[330px]"
          src={userImage}
          alt=""
        />
        <h2 className="mt-10 mb-10 text-7xl font-eczar dark:text-white">
          Joshua Stroud
        </h2>
        <p className="mt-10 mb-10 font-ubuntu text-2xl italic text-[#666666]  dark:text-[#acacac]">
          Software Developer
        </p>
        {/* Avatar Info End */}

        {/* Social information start */}
        <div className="flex mt-5 mb-5 space-x-3">
          <a
        ...
        <button className="flex mt-10 mb-10 items-center bg-[#F3F6F6] dark:bg-[#FFFFFF] duration-200 transition ease-linear hover:bg-slate-400  px-8 py-3 text-lg text-black outline-black rounded-[35px] mt-6">
